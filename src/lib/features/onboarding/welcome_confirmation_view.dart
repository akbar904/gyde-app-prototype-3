...
class WelcomeConfirmationViewModel extends BaseViewModel {
  void onContinue() {
    // Handle navigation to the next onboarding step
    // For the sake of this example, we'll just print to the console
    print('Navigating to Terms and Conditions View');
